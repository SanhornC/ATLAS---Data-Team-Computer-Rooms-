...
output_path = '/Users/sanhorn/Desktop/Internships/ATLAS - Data Team/Computer-Rooms/Dataset/spring_noclass_timerecord.xlsx'


time_blocks = [f"{hour:02d}:00{'AM' if hour < 12 else 'PM'}" for hour in range(8, 19)]
...
with pd.ExcelWriter(output_path) as writer:
    for sheet_name in excel_data.sheet_names:
        ...
        for _, row in room_data.iterrows():
            ...
            if day_name in weekdays and pd.notnull(class_name):
                try:
